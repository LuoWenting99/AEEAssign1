function [file, signal, acq, track, solu, cmn] = initParameters_Urban()
%Purpose:
...
%% File parameters
file.fileName       = 'Urban';  
file.fileRoute      = ['D:\00_HK\Class_GNSS\Demo_V\New version Supporting 16bit - Copy\New version Supporting 16bit\DataSample\',file.fileName,'.dat'];  
...
solu.mode  	= 1;    % 0:conventional WLS; 1:EKF
solu.iniPos	= [22.3198722/180 * pi, 114.209101777778/180 * pi, 3]; % Ground truth location 
